...
= 2.3.9 (2025-05-12) =
* TWEAKED Popups without overlays will be considered non-blocking, allow other popups to appear.
...
= 2.3.4 (2023-10-04) =
* IMPROVED Custom form code works more effectively now.

= 2.3.3.1 (2023-09-08) =
* FIXED Redirect on YES click not working

= 2.3.3 (2023-08-23) =
* FIXED Escape placeholder attributes in form inputs.

= 2.3.2 (2023-08-08) =
* ADDED Pagination to report tables.
...
* ADDED Size and icon options for the close button.
* TWEAKED Notification popups will block other notifications popups if they are in the same position.
* FIXED PHP Warning in the admin table
...
= 2.0.9 (2022-08-17) =
* ADDED Escape key support for closing focused popups.
* TWEAKED After 2 seconds clicking on a popup overlay will close the popup.
* FIXED Significantly better support for shortcode content like forms.
* FIXED Zapier integration not registered in backend.
