...
return;}d.ajax({method:"GET",url:c.hollerVars.ajaxurl,data:{email:g,list_id:f,action:"hwp_mc_subscribe",nonce:c.hollerVars.hwpNonce}}).done(function(i){console.log(i);
