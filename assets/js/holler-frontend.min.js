...
}},f*1000);}else{b.detectScroll(k);}};b.noteListeners=function(f){d("body").on("click",".hwp-close",b.hideItem).on("click","#hwp-floating-btn",b.btnClick).on("click",".hwp-interaction",b.interactionLink).on("click",".hwp-text i",b.sendText).on("click","#hwp-"+f+" .hwp-email-btn",b.emailSubmitClick);
