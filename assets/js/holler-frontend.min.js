...
}if(f.showChat==="1"){b.clearChat(h);}};b.countNoteShown=function(i){var f=c.hollerVars[i];var g=(f.hideForDays?parseInt(f.hideForDays):1);b.setCookie("hwp_"+i+"_shown","true",g);
var h={action:"hwp_track_view",nonce:c.hollerVars.hwpNonce,id:i};d.ajax({method:"GET",url:c.hollerVars.ajaxurl,data:h}).done(function(j){}).fail(function(j){});
