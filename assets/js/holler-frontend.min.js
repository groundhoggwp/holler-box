...
}if(j.btnColor1){d("#hwp-"+k+" .hwp-email-btn, #hwp-floating-btn").css("background-color",j.btnColor1);}if(j.display_when!="scroll"){if(j.display_when==="exit"&&!f){return;
...
}if(f.showChat==="1"){b.clearChat(h);}};b.countNoteShown=function(i){console.log("count shown "+i);var f=c.hollerVars[i];var g=(f.hideForDays?parseInt(f.hideForDays):1);
