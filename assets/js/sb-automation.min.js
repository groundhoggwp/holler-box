...
d(".sb-text-input").on("keypress",b.submitChatTextOnEnter);d(".sb-email-input").on("keypress",b.submitEmailOnEnter);};b.detectScroll=function(){d(c).scroll(b.debounce(function(){if(d(c).scrollTop()>=850&&!b.show[b.activeID]){b.showNote();
b.show[b.activeID]=true;}},250));};b.fullRight=function(){var f=d("#"+b.activeID);f.toggleClass("sb-full-right");f.toggleClass("sb-minimizing",!f.hasClass("sb-full-right"));
setTimeout(function(){f.removeClass("sb-minimizing");},30000);return false;};b.showNote=function(){var f=b.activeOptions;var h=a.getElementById(b.activeID);
b.firstRow.innerHTML=f.content;if(f.hideFirst==="true"||c.localStorage.getItem("sb_hide_note")==="true"){b.transitionOut(h);if(f.showBtn!="false"){b.transitionIn(b.floatingBtn);
}}else{b.transitionIn(h);if(f.showBtn!="false"){b.transitionOut(b.floatingBtn);}}if(f.showOptin==="1"&&f.showChat!="1"){b.transitionIn(b.noteOptin);var g=a.querySelector("#"+b.activeID+" .sb-email-input");
...
b.debounce=function(g,f){var h=null;return function(){var j=this,i=arguments;clearTimeout(h);h=setTimeout(function(){g.apply(j,i);},f);};};b.hideItem=function(f){b.toggleHide();
