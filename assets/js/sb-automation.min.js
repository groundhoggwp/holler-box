...
}};b.doActive=function(g){for(var f=0;f<g.length;f++){b.doChecks(g[f]);}};b.doChecks=function(i){console.log("dochecks"+i);var g=a.getElementById("sb-"+i);
if(!g){return;}var h=c.sbAutoVars[i];if(!h.visitor){return;}if(h.visitor==="new"&&b.newVisitor!=true){return;}if(h.visitor==="returning"&&b.newVisitor!=false){return;
}b.activeID="sb-"+i;b.activeOptions=h;b.cacheSelectors();b.noteListeners();if(h.display_when!="scroll"){var f=(h.display_when==="delay"?parseInt(h.delay):0);
setTimeout(function(){b.showNote();},f*1000);}else{}};b.checkCookie=function(){if(b.getCookie("sb_visit")===""){b.setCookie("sb_visit",Date.now(),parseInt(c.sbAutoVars.expires));
