...
f.toggleClass("sb-minimizing",!f.hasClass("sb-full-side"));setTimeout(function(){f.removeClass("sb-minimizing");},30000);return false;};b.showNote=function(){console.log(b.activeID);
...
d(".sb-away-msg").remove();d("#"+b.activeID+" .sb-email-row").prepend('<span class="sb-away-msg">'+b.activeOptions.optinMsg+"</span>");}if(f.hideBtn==="1"){b.hide(b.floatingBtn);
}if(f.position==="sb-banner-top"&&b.getCookie(b.activeID+"_hide")!="true"){b.toggleBannerClass();}if(f.hide_after==="delay"){setTimeout(function(){b.transitionOut(h);
...
};b.interacted=function(f){var h=b.activeID.split("-")[1];var g={action:"sb_track_event",nonce:c.sbAutoVars.sbNonce,id:h};if(f.data){g.details=f.details;
...
};b.handleForms=function(f){console.log("handleForms");b.interacted(null);d(this).hide();b.showConfirmation();};b.showConfirmation=function(){b.firstRow.innerHTML=b.activeOptions.confirmMsg;
