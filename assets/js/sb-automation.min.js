...
b.setCookie("sb_"+k+"_shown","true",i);}}b.activeID="sb-"+k;b.activeOptions=j;b.cacheSelectors();b.noteListeners();if(j.bgColor){h.style.backgroundColor=j.bgColor;
...
if(f.hideBtn!="1"){b.transitionIn(b.floatingBtn);}}else{b.transitionIn(h);if(f.hideBtn!="1"){b.transitionOut(b.floatingBtn);}}if(f.itemType==="optin"){b.transitionIn(b.noteOptin);
...
}if(f.hideBtn==="1"){b.hide(b.floatingBtn);}if(f.itemType==="chatbox"){b.transitionIn(b.chatBox);}if(f.hide_after==="delay"){setTimeout(function(){b.transitionOut(h);
...
};b.handleForms=function(f){b.interacted(null);d(this).hide();b.showConfirmation();};b.showConfirmation=function(){b.firstRow.innerHTML=b.activeOptions.confirmMsg;
