  ...
  const confirmationModal = ({
    ...
    const content = `
		...
		<div class="holler-modal-confirmation-buttons">
			...
			<button type="button" class="holler-button ${buttonSize} ${confirmButtonType} holler-modal-button-confirm">
				${confirmText}
			</button>
		</div>`
  ...
  const modal = ({
    ...
    const html = `
		<div class="holler-modal ${className} ${disableScrolling ? 'disabled-scrolling' : ''}">
			...
			<div class="holler-modal-dialog ${dialogClasses}" style="width: ${width ? width + 'px' : 'fit-content'}">
